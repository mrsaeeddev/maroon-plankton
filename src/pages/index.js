  ...
  <Layout>
      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            ...
            I have got 190K+ views on The Dev Community and 10K+ views on Medium.
            <br />
            <b>If you want to discuss something, Just reach out to me at any of my social media handles.
            </b>
          </p>
        </div>
    ...
    <section id="two" className="main special">
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            So, being an Engineer, I am found in making new features, fighting with bugs and  
            focusing on how to improve myself as a coder.
          </p>
          <ul className="icons-grid">
            <li>
              <span className="icon major fas fa-chart-bar" />
              <h3>Playing with Data</h3>
            </li>
            <li>
              <span className="icon major fas fa-pencil-alt" />
              <h3>Writing about tech</h3>
            </li>
            <li>
    ...
    <section id="footer">
      <div className="container">
        ...
        <b>Call me at <a href="tel:+923138167414">+92 - 313 816 7414</a></b>
        <div>Or</div>
        <b>Shoot me an email at : <a href="email:saeed_dev@yahoo.com"> saeed_dev@yahoo.com</a>
        </b>
